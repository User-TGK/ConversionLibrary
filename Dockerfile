...
ENV LOGGING_FILE /config/logs/Logfile.txt

CMD ./DataConversionServer/build/DataConversionServer --config=${CONFIG_PATH} --sources-config=${SOURCES_PATH} --log-file=${LOGGING_FILE}