...
public:
	...
	*/
	...
	{
		AddNumberError(
			SchemaType::GetMaxLengthString(), ValueType(str, length, GetStateAllocator()).Move(), SValue(expected).Move());
	}
	void TooShort(const Ch* str, SizeType length, SizeType expected)
	{
		AddNumberError(
			SchemaType::GetMinLengthString(), ValueType(str, length, GetStateAllocator()).Move(), SValue(expected).Move());
	}
	...
	void DisallowedProperty(const Ch* name, SizeType length)
	{
		...
		currentError_.AddMember(
			GetDisallowedString(), ValueType(name, length, GetStateAllocator()).Move(), GetStateAllocator());
